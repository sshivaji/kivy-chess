...
#ifndef AGCHESS_STANDARD_CHESS_GAME_H
#define AGCHESS_STANDARD_CHESS_GAME_H
...
namespace AGChess {
    ...
    class StandardChessGame : public GameTree, public GameHeaders {
    public:
        StandardChessGame();
        StandardChessGame(const std::string& gameText);
    };    
}
